...
class luis extends StatefulWidget {
  const luis({Key? key}) : super(key: key);

  @override
  State<luis> createState() => _luisState();
}

class _luisState extends State<luis> {
  List<Post> _posts = [];
  List<Album> _albums = [];
          ...
          children: [
            DrawerHeader(
              child: UserAccountsDrawerHeader(
                ...
                accountEmail: Text('cabarcas@gmail.com'),
              ),
            ),
            ListTile(
              title: Text('inicio'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          ListTile(
            title: Text('Luis cabarcas'),
            subtitle: Text('Luis cabarcas'),
          ...
          ListTile(
            title: Text('correo'),
            subtitle: Text('cabarcas@gmail.com'),
